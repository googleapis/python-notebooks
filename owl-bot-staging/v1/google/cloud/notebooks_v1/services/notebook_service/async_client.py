...
class NotebookServiceAsyncClient:
    ...
    async def update_shielded_instance_config(self,
    ...
    async def update_instance_metadata_items(self,
    ...
    async def get_instance_health(self,
    ...
    async def rollback_instance(self,
    ...
    async def diagnose_instance(self,
