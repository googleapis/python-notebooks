...
class ManagedNotebookServiceClient(metaclass=ManagedNotebookServiceClientMeta):
    ...
    def runtime_path(project: str,location: str,runtime: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/runtimes/{runtime}".format(project=project, location=location, runtime=runtime, )

    @staticmethod
    def parse_runtime_path(path: str) -> Dict[str,str]:
        """Parses a runtime path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/runtimes/(?P<runtime>.+?)$", path)
    ...
    def update_runtime(self,
        ...
        Args:
            request (Union[google.cloud.notebooks_v1.types.UpdateRuntimeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_runtime]
    ...
    def upgrade_runtime(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.upgrade_runtime]
    ...
    def refresh_runtime_token_internal(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.refresh_runtime_token_internal]
    ...
    def diagnose_runtime(self,
        ...
        Args:
            request (Union[google.cloud.notebooks_v1.types.DiagnoseRuntimeRequest, dict]):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.diagnose_runtime]
