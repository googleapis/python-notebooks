...
from google.cloud.notebooks_v1.types.managed_service import RefreshRuntimeTokenInternalRequest
from google.cloud.notebooks_v1.types.managed_service import RefreshRuntimeTokenInternalResponse
