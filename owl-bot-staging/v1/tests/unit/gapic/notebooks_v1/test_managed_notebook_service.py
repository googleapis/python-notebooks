...
@pytest.mark.parametrize("client_class", [
    ManagedNotebookServiceClient, ManagedNotebookServiceAsyncClient
])
@mock.patch.object(ManagedNotebookServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ManagedNotebookServiceClient))
@mock.patch.object(ManagedNotebookServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ManagedNotebookServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ManagedNotebookServiceClient, transports.ManagedNotebookServiceGrpcTransport, "grpc", grpc_helpers),
    (ManagedNotebookServiceAsyncClient, transports.ManagedNotebookServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
...
async def test_list_runtimes_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_runtimes(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_update_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_upgrade_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.upgrade_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_refresh_runtime_token_internal(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.refresh_runtime_token_internal),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_diagnose_runtime(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.diagnose_runtime),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (ManagedNotebookServiceAsyncClient, transports.ManagedNotebookServiceGrpcAsyncIOTransport),
])
