...
from google.cloud.notebooks_v1.services.notebook_service.transports.base import _GOOGLE_AUTH_VERSION
...
def test_create_instance_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].instance == gcn_instance.Instance(name='name_value')
...
def test_update_instance_config(transport: str = 'grpc', request_type=service.UpdateInstanceConfigRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_config_from_dict():
    test_update_instance_config(request_type=dict)
...
def test_update_shielded_instance_config(transport: str = 'grpc', request_type=service.UpdateShieldedInstanceConfigRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_shielded_instance_config_from_dict():
    test_update_shielded_instance_config(request_type=dict)
...
def test_get_instance_health(transport: str = 'grpc', request_type=service.GetInstanceHealthRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_health_from_dict():
    test_get_instance_health(request_type=dict)
...
def test_rollback_instance(transport: str = 'grpc', request_type=service.RollbackInstanceRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rollback_instance_from_dict():
    test_rollback_instance(request_type=dict)
...
def test_create_environment_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].environment == gcn_environment.Environment(name='name_value')
...
def test_list_schedules(transport: str = 'grpc', request_type=service.ListSchedulesRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_schedules_from_dict():
    test_list_schedules(request_type=dict)
...
def test_get_schedule(transport: str = 'grpc', request_type=service.GetScheduleRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_schedule_from_dict():
    test_get_schedule(request_type=dict)
...
def test_delete_schedule_from_dict():
    test_delete_schedule(request_type=dict)
...
def test_create_schedule(transport: str = 'grpc', request_type=service.CreateScheduleRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_schedule_from_dict():
    test_create_schedule(request_type=dict)
...
def test_create_schedule_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].schedule == gcn_schedule.Schedule(name='name_value')
        assert args[0].schedule_id == 'schedule_id_value'
...
def test_trigger_schedule(transport: str = 'grpc', request_type=service.TriggerScheduleRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_trigger_schedule_from_dict():
    test_trigger_schedule(request_type=dict)
...
def test_list_executions(transport: str = 'grpc', request_type=service.ListExecutionsRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_execution(transport: str = 'grpc', request_type=service.GetExecutionRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_execution(transport: str = 'grpc', request_type=service.DeleteExecutionRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_execution(transport: str = 'grpc', request_type=service.CreateExecutionRequest):
    client = NotebookServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_execution_flattened():
    ...
    with mock.patch.object(
        ...
        _, args, _ = call.mock_calls[0]
        assert args[0].parent == 'parent_value'
        assert args[0].execution == gcn_execution.Execution(execution_template=gcn_execution.ExecutionTemplate(scale_tier=gcn_execution.ExecutionTemplate.ScaleTier.BASIC))
