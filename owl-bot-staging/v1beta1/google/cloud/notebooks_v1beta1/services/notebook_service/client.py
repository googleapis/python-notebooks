...
class NotebookServiceClient(metaclass=NotebookServiceClientMeta):
    ...
    def is_instance_upgradeable(self,
        ...
        """
        warnings.warn("NotebookServiceClient.is_instance_upgradeable is deprecated",
            DeprecationWarning)
    ...
    def upgrade_instance(self,
        ...
        """
        warnings.warn("NotebookServiceClient.upgrade_instance is deprecated",
            DeprecationWarning)
    ...
    def upgrade_instance_internal(self,
        ...
        """
        warnings.warn("NotebookServiceClient.upgrade_instance_internal is deprecated",
            DeprecationWarning)
