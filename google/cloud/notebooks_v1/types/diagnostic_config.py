...
class DiagnosticConfig(proto.Message):
    ...
    Attributes:
        ...
        relative_path (str):
            ...
            bucket (gs://$GCS_BUCKET/$DATE_$TIME.tar.gz) Example of full
    ...
    repair_flag_enabled: bool = proto.Field(
        proto.BOOL,
        number=3,
    )
    packet_capture_flag_enabled: bool = proto.Field(
        proto.BOOL,
        number=4,
    )
    copy_home_files_flag_enabled: bool = proto.Field(
        proto.BOOL,
        number=5,
    )
